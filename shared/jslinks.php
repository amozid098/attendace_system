...
<script src="source/dist/js/bootstrapValidator.min.js"></script>
<!-- Morris.js charts -->
...
<!-- datepicker -->
<script src="source/plugins/datepicker/bootstrap-datepicker.js"></script>
<!-- Bootstrap WYSIHTML5 -->
...
<script src="source/dist/js/jquery.dataTables.min.js"></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="source/dist/js/pages/dashboard.js"></script>
<!-- AdminLTE for demo purposes -->
<script src="source/dist/js/demo.js"></script>
<script src="source/dist/js/bootstrap-timepicker.js"></script>